...
2. In each copy, change `APP_INSTANCE_LABEL` in `static/hello-world/src/index.js` to a unique value such as `APP_A` and `APP_B`. In this prepared copy, the label is already set to `APP_B`.
